...
function initAuthListener() {
    onAuthStateChanged(auth, async (user) => {
        ...
        if (currentUser) {
            ...
            chatList.innerHTML = '<div class="p-3 text-center text-muted"><i class="bi bi-chat-dots display-4"></i><br><br>Please log in to view your chats</div>';
            chatMessages.innerHTML = '<div class="p-5 text-center text-muted"><i class="bi bi-chat-square-text display-1"></i><br><br>Select a chat to start messaging</div>';
