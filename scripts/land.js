...
// DOM Elements
const landPropertiesContainer = document.getElementById('landProperties');
...
function loadLandProperties(searchTerm = '', page = 1, pageSize = 6) {
    ...
    `;
    landPropertiesContainer.appendChild(paginationContainer);
    ...
    paginationContainer.querySelectorAll('.page-link').forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            if (newPage) loadLandProperties(searchTerm, newPage, pageSize);
        });
    });

    landPropertiesContainer.querySelectorAll('.property-card').forEach(card => {
...
function handleSearch() {
    ...
    loadLandProperties(searchTerm, 1);
}
